...
public class PumpkinThrower : MonoBehaviour
{
    ...
    [SerializeField] private float attackInterval = 1f; // DPS
    [SerializeField] private int damage = 50; // Damage
    ...
    private void Update()
    {
        ...
        if (target != null)
        {
            ...
            {
                target.GetComponent<EnemyHP>().hp -= damage;
                timeOnTarget = 0f;
